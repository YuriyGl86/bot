...
def write_message(authorize, sender, keyboard, message, attachment=None):
    authorize.method('messages.send', {'user_id': sender, 'message': message, 'random_id': get_random_id(), 'attachment': attachment, 'keyboard': keyboard.get_keyboard()})
...
class Bot:
    ...
    def __init__(self, key):
        ...
        self.longpoll = VkLongPoll(self.authorize)  # Выбираем тип используемого API - Long Poll API, бывает еще Callback API
